...
## Output format
##### Below is the format of the datatypes outputted when printing. Each datatype is a list of dictionaries
...
## Misc Notes
- Program does **not** allow for conflictions (no need to implement fixing algorithm)
